<template>
  <div class="app-container">
    <!-- 授权用户 -->
    <el-dialog title="选择教职工" :visible.sync="visible" width="900px" top="5vh" append-to-body>
      ...
      <el-table ref="table" v-loading="loading" :data="teacherList" @selection-change="handleSelectionChange"  @select="rowSelected">
