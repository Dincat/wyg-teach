<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="院校ID" prop="collegeId">
        <el-input
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="院校ID" align="center" prop="collegeId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="院校ID" prop="collegeId">
          <el-input v-model="form.collegeId" placeholder="请输入院校ID" />
        </el-form-item>
        <el-form-item label="专业ID" prop="majorId">
        ...
        <el-form-item label="课时数" prop="period">
          <el-input v-model="form.period" placeholder="请输入课时数" />
        </el-form-item>
