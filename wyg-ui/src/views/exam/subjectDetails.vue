<template>
  <div class="app-container">
    <el-row>
      <el-col :span="4">
        <subject-category-tree @selected="handleCategorySelected"/>
      </el-col>
      <el-col :span="20">
        <div>
...
export default {
  name: 'SubjectDetails',
  components: { SpinnerLoading, Choices, MultipleChoices, ShortAnswer, Judgement, CategorySubjects,SubjectCategoryTree },
  directives: {
    waves
  },
  data () {
  ...
  methods: {
    ...
    // 更新题目
    updateSubjectData () {
      if (this.categoryId === undefined || this.categoryId === '' || this.categoryId <1) {
        this.$message({
          message: '请选择分类',
          type: 'warning'
        })
