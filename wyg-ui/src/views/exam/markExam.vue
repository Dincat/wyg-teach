...
<!--                </el-col>-->
                ...
                <el-col :span="8">
                  <el-form-item label="状态：">
                    <dict-tag :options="dict.type.mark_status" :value="tempAnswer.markStatus"/>
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="答题结果：">
                  <el-switch style="display: block" v-model="correct" active-color="#13ce66" inactive-color="#ff4949"
                             active-text="正确" inactive-text="错误">
                  </el-switch>
                </el-form-item>
              </el-col>
            </el-row>
  ...
  methods: {
    ...
    handleMarking () {
      getAnswerByRecordId(this.examRecordId, undefined, undefined).then(response => {
        ...
        if(this.tempAnswer.markStatus!=1){
          this.score=tempAnswer.subject.answer.score;
          this.correct=tempAnswer.subject.answer.answer===tempAnswer.answer;
        }
