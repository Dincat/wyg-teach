...
<script>
  import { getPage, getMaterialVideo } from '@/api/wechat/mp/wxmaterial'
  import WxNews from '@/components/wx-news/main'
  import WxMaterialSelect from '@/components/wx-material-select/main'
  import WxVoicePlayer from '@/components/wx-voice-play/main'
