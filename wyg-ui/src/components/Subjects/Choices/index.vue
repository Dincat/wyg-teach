          ...
          <el-row>
            <el-col :span="24">
              <el-form-item :label="$t('table.subjectName')" prop="subjectName">
                <TinymceEdtor ref="subjectNameEditor" height="360px" v-model="subjectInfo.subjectName"/>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
              ...
              <el-form-item v-for="(option, index) in options" :label="option.optionName" :key="option.optionName"
                ...
                <el-row :gutter="5">
                  ...
                  <el-col :span="21">
                    <el-row :gutter="5">
                      <el-col :span="23">
                        <TinymceEdtor height="260px" v-model="option.optionContent"/>
                      </el-col>
                      <el-col :span="1">
                        <el-button @click.prevent="removeOption(option)" type="danger">删除</el-button>
                      </el-col>
                    </el-row>
                  </el-col>
                </el-row>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item :label="$t('table.subject.analysis')" prop="analysis" class="analysis-form-item">
                <TinymceEdtor ref="analysisEditor" height="260px" v-model="subjectInfo.analysis"/>
              </el-form-item>
            </el-col>
          </el-row>
        </div>
