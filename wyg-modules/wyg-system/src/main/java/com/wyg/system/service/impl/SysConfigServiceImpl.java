...
import com.wyg.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    @Override
    public List<SysConfig> selectConfigByKeys(String[] configKeys){
        return configMapper.selectConfigByKeys(configKeys);
    }
}
