package com.wyg.common.security.service;
...
public class TokenService
{
    ...
    public Map<String, Object> createToken(LoginUser loginUser)
    {
        ...
        claimsMap.put(SecurityConstants.DETAILS_USER_TYPE, loginUser.getSysUser().getUserType());
        claimsMap.put(SecurityConstants.DETAILS_COLLEGE_ID, loginUser.getCollege()==null?null:loginUser.getCollege().getDeptId());
